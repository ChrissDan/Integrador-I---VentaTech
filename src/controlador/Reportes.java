    ...
    *********************************************************************** */
    public void ReportesClientes() {
        ...
        try {
            ...
            String ruta = "C:" + File.separator + "Users" + File.separator + "Admin" + File.separator + "Documents" + File.separator + "NetBeansProjects" + File.separator + "VentaTech" + File.separator + "src" + File.separator + "reportes";
            
            File carpeta = new File(ruta);
            
            if (!carpeta.exists()) {
                carpeta.mkdirs(); // Crea la carpeta, incluidas las subcarpetas necesarias
            }

            //String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + File.separator + "Reporte_Clientes.pdf"));
            ...
            parrafo.add("Reporte creado por Venta-Tech \n ©Grupo 8\n\n");
    ...
    *********************************************************************** */
    public void ReportesProductos() {
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + File.separator + "Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesCategorias() {
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + File.separator + "Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    *********************************************************************** */
    public void ReportesVentas() {
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + File.separator + "Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
