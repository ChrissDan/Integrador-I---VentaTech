...
public class InterGestionarVentas extends javax.swing.JInternalFrame {
    ...
    public InterGestionarVentas() {
        initComponents();
        this.setTitle("VentaTech - GESTIONAR VENTAS");
    ...
    private void jButton_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarActionPerformed
        ...
        // Actualizar datos
        if (!cliente.equalsIgnoreCase("Seleccione un Cliente:")) {
    ...
    private void Limpiar() {
        ...
        this.jComboBox_cliente.setSelectedItem("Seleccione un Cliente:");
    ...
    private void EnviarDatosVentaSeleccionado(int idVenta) {
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement(
                    ...
                    + "as cliente, cv.valorPagar, cv.fechaVenta, cv.estado "
