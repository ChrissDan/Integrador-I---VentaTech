...
public class InterUsuario extends javax.swing.JInternalFrame {
    ...
    public InterUsuario() {
        ...
        this.setTitle("VentaTech - NUEVO USUARIO");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jCheckBox_ver_clave, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 143, -1, -1));
    ...
    private void jButton_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_guardarActionPerformed
        ...
        if (txt_nombre.getText().isEmpty() || txt_apellido.getText().isEmpty() || txt_usuario.getText().isEmpty() || 
            ...
            //validamos si esta registrado el usuario
