...
public class InterActualizarStock extends javax.swing.JInternalFrame {
    ...
    public InterActualizarStock() {
        initComponents();
        setTitle("VentaTech - ACTUALIZAR STOCK");
    ...
    private void initComponents() {
        ...
        txt_cantidad_actual.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        txt_cantidad_nueva.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jComboBox_producto.getSelectedItem().equals("Seleccione Producto:")) {
            ...
            if (!txt_cantidad_nueva.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Ingrese el Stock nuevo");
            }
    ...
    //Metodo para mostrar stock de producto seleccionado
